...
[**Prime Factorization**](/Prime_Factorization) – Have the user enter a number and find all Prime Factors (if there are any) and display them.

[**Next Prime Number**](/Next_Prime_Number) – Have the program find prime numbers until the user chooses to stop asking for the next one.
